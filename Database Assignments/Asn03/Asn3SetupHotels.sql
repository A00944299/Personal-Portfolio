...
SPOOL C:\Users\chris\Desktop\Assignment03_QinC.txt
...
FROM Room
  NATURAL JOIN Hotel
WHERE type = ANY('Single', 'Double', 'Family', 'Deluxe')
AND country = 'France';
...
AND type = ANY('Single', 'Double', 'Family', 'Deluxe');

-- Question 2:
SELECT hotelName, dateTo, dateFrom, COUNT(guestNo)
FROM
