...
--  When coding, use multiple lines with PROPER INDENTATION
--    levels to make your code readable. in this sample,
--    3 spaces (NOT tabs) are used to indent each level of coding.
--
-- ---------------------------------------------------------
--  The next SQL*Plus commands set SQL*Plus echo on and tab off.
--  With echo on, commands inside script files like this one
--    will be echoed to the screen, together with any output
--    results. With tab off, consecutive spaces will not be
...
--
SPOOL C:\Users\chris\Desktop\Lab01_QinC.txt
-- ---------------------------------------------------------
...
INSERT INTO OrderTbl
   VALUES ('O1116324',DATE'2019-01-23','C0954327');
...
--
--
-- Q.8a - BAD coding, though there is no syntax errors
--      - Can you read and make sense out of this easily?
select c.CustNo, CustFirstName, CustLastName, o.OrdNo, OrdDate,
p.ProdNo, ProdName, ProdPrice from Customer c join OrderTbl o on c.CustNo
= o.CustNo join OrdProd op on o.OrdNo = op.OrdNo join Product p on op.ProdNo
= p.ProdNo where OrdDate > DATE'2019-01-01' and c.CustNo = 'C0954327';
--
-- Q.8b *** Note sample coding style *** Make code readable ***
--     Use multiple lines with proper indentation levels
--       instead of long lines, and avoid line wraps.
--     In this sample, 2 spaces are used to indent each level of coding.
--
